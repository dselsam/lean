...
public:
    ...
    virtual expr mk_lambda(std::initializer_list<expr> const & locals, expr const & e);
    virtual expr mk_pi(std::initializer_list<expr> const & locals, expr const & e);
    virtual bool is_prop(expr const & e);
