...
name const & get_BitVec_name();
name const & get_BitVec_zero_name();
name const & get_BitVec_one_name();
name const & get_BitVec_add_name();
name const & get_BitVec_mul_name();
name const & get_BitVec_has_zero_name();
name const & get_BitVec_has_one_name();
name const & get_BitVec_has_add_name();
name const & get_BitVec_has_mul_name();
...
name const & get_ConcreteArithType_name();
name const & get_ConcreteArithType_Int_name();
name const & get_ConcreteArithType_Real_name();
name const & get_ConcreteArithType_BitVec_name();
...
name const & get_Int_zero_name();
name const & get_Int_one_name();
name const & get_Int_add_name();
name const & get_Int_mul_name();
...
name const & get_Real_zero_name();
name const & get_Real_one_name();
name const & get_Real_add_name();
name const & get_Real_mul_name();
