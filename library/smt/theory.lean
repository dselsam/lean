...
noncomputable instance : has_sub Int := ⟨sub⟩
noncomputable instance : has_div Int := ⟨div⟩
noncomputable instance : has_lt Int := ⟨lt⟩
noncomputable instance : has_le Int := ⟨le⟩
noncomputable instance : decidable_eq Int := dec_eq
...
noncomputable instance : has_sub Real := ⟨sub⟩
noncomputable instance : has_div Real := ⟨div⟩
